...
public class TestMcmsPage {
    ...
    public void test1() {
        ...
        String url = "http://api.m.cms.lecloud.com/page/getDataByPage/" + userId + "/422/1/10/" + token;
        //String url = "http://localhost:90/page/getDataByPage/" + userId + "/319/1/10/" + token;
        String result = HttpClientUtils.get(url);
